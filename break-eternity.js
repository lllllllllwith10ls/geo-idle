  ...
  function () {
    ...
    Decimal.prototype.toString = function () {
      if (this.layer === 0)
      {
        ...
        {
          return "decimal " + (this.sign*this.mag).toString();
        }
        return "decimal " + this.m + "e" + this.e;
      }
      else if (this.layer === 1)
      {
        return "decimal " + this.m + "e" + this.e;
      ...
      else
      {
        ...
        {
          return "decimal " + (this.sign === -1 ? "-" : "") + "e".repeat(this.layer) + this.mag;
        }
        else
        {
          return "decimal " + (this.sign === -1 ? "-" : "") + "(e^" + this.layer + ")" + this.mag;
        }
      }
    };
